...
// @name         GLB
// @version      3.0.0
// @description  GL BOT FARM
// @author       NA
// @match        *://*.gladiatus.gameforge.com/game/index.php*
// @exclude      *://*.gladiatus.gameforge.com/game/index.php?mod=start
// @downloadURL  https://github.com/lordspown/glb/raw/master/glb-script.user.js
// @updateURL    https://github.com/lordspown/glb/raw/master/glb-script.user.js
// @grant        GM_addStyle
// @grant        GM_getResourceText
// @require      https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js
// @resource     customCSS_global  https://raw.githubusercontent.com/lordspown/glb/master/global.css?ver=2.6.4
// ==/UserScript==
...
(function() {
    ...
    *****************/  
    ...
    const assetsUrl = 'https://raw.githubusercontent.com/lordspown/glb/master/assets';
            ...
            function goArena() {
                ...
                if (!inArenaPage && player.level < 10) {
                    ...
                    if (!inArenaProvPage) {
						...
						// Mesaj atacuri multiple
                        if (document.getElementById("blackoutDialogbod") !== null) {
							setTimeout(function(){
                            document.getElementById("blackoutDialogbod").querySelector("#linkbod").click();
                            }, clickDelay);
                        };
                        // Close Notifications
